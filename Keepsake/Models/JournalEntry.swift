...
class WrittenEntry: JournalEntry {
    ...
    init(id: UUID = UUID(), date: String, title: String, text: String, summary: String, width: Int = 1, height: Int = 1, isFake: Bool = false, color: [Double] = [0.5,0.5,0.5], selectedPrompt: String = "") {
        self.text = text
    ...
    override static func fromDictionary(_ dict: [String: Any]) -> WrittenEntry? {
        ...
        return WrittenEntry(id: id, date: date, title: title, text: text, summary: summary, width: width, height: height, isFake: isFake, color: color, selectedPrompt: selectedPrompt)
