...
extension JournalPage: CustomStringConvertible {
    ...
    static func dailyReflectionTemplate(pageNumber: Int) -> JournalPage {
        ...
        // Image
        let image = PictureEntry(date: "", title: "Pics of the Day", images: [], width: 1, height: 2, isFake: false, color: color(1.0, 1.0, 1.0))
        entries.append(image)
        
        // Prompt
        let prompt = WrittenEntry(date: "", title: "Prompt of the Day", text: "", summary: "Imagine that you’re a famous inventor. What would you invent and why?", width: 1, height: 1, isFake: false, color: color(0.8, 1.0, 1.0))
        ...
        // Memo
        let memo = VoiceEntry(date: "", title: "Memo 1", audio: nil, width: 1, height: 1, isFake: false, color: color(0.9, 1.0, 0.9))
        entries.append(memo)
        
        // Daily Reflection
        let reflection = WrittenEntry(date: "", title: "Daily Reflection", text: "", summary: "How was your day today?", width: 2, height: 2, isFake: false, color: color(0.9, 0.85, 1.0))
    ...
    static func springBreakTemplate(pageNumber: Int) -> JournalPage {
        ...
        // Image 1
        let image = PictureEntry(date: "", title: "Pics of the Trip", images: [], width: 1, height: 2, isFake: false, color: color(1.0, 1.0, 1.0))
        entries.append(image)
        
        // Prompt
        let prompt = WrittenEntry(date: "", title: "Summarize your spring break", text: "", summary: "Give a summary of your trip here", width: 1, height: 1, isFake: false, color: color(0.8, 1.0, 1.0))
        entries.append(prompt)
        entries += Array(repeating: WrittenEntry(date: "", title: "", text: "", summary: "", width: 1, height: 1, isFake: true, color: [0.5, 0.5, 0.5]), count: 1)
        ...
        // Daily Reflection
        let reflection = WrittenEntry(date: "", title: "Daily Reflections of your Spring Break", text: "", summary: "How was each day?", width: 2, height: 1, isFake: false, color: color(0.9, 0.85, 1.0))
        entries.append(reflection)
        entries += Array(repeating: WrittenEntry(date: "", title: "", text: "", summary: "", width: 1, height: 1, isFake: true, color: [0.5, 0.5, 0.5]), count: 1)
        
        // Image 2
        let image2 = PictureEntry(date: "", title: "Pics of the Trip", images: [], width: 1, height: 2, isFake: false, color: color(1.0, 1.0, 1.0))
        entries.append(image2)
        
        // Image 3
        let image3 = PictureEntry(date: "", title: "Pics of the Trip", images: [], width: 1, height: 2, isFake: false, color: color(1.0, 1.0, 1.0))
